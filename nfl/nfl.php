...
<?php include "inc/nav.php";?>
			...
			<article>
				...
				<h2 class = "container"> Background </h2>
				...
				<p>
					...
					The Green Bay Packers hold the most combined NFL championships with thirteen, winning nine titles before the Super Bowl era and four Super Bowls afterwards. Since the creation of the Super Bowl, the Pittsburgh Steelers and New England Patriots both have the most championship titles at six.
				</p>
				...
				<p>
					From 1920 to 1934, the NFL did not have a set number of games for teams to play, instead setting a minimum. The league mandated a twelve-game regular season for each team beginning in 1935, later shortening this to eleven games in 1937 and 10 games in 1943, mainly due to World War II. After the war ended, the number of games returned to eleven games in 1946, and later back to twelve in 1947. The NFL went to a fourteen-game schedule in 1961, which it retained until switching to the current sixteen-game schedule in 1978. In March 2021, the NFL officially adopted a seventeen-game schedule after gaining the agreement of the National Football League Players Association (NFLPA).
				...
				<p>
					...
					In addition to radio networks run by each NFL team, select NFL games are broadcast nationally by Westwood One (known as Dial Global for the 2012 season). These games are broadcast on over 500 networks, giving all NFL markets access to each primetime game. The NFL's deal with Westwood One was extended in 2012 and continued through 2017.
					...
					The NFL finished the new contract negotiation for the media rights deal worth over $110 billion on March 18, 2021. In this contract, ABC will be eligible to broadcast the Super Bowl on U.S. television for the first time since it broadcast Super Bowl XL after the end of the 2005 NFL season. Also in current agreement, Amazon will be the new home for Thursday Night Football starting in 2023.
